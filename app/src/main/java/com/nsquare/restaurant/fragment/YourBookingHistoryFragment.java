...
public class YourBookingHistoryFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        fragment_recent_jobs_recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intentForgotPassword.putExtra(getResources().getString(R.string.key_flag), "1");
    ...
    private void setListValues(){
        ...
        upcomingYourBookingModelArrayList.add(new UpcomingYourBookingModel("1", "Hard Rock Cafe", "12A, Sector 12, Main Road, Noida", "", "Wed 23 Sept, 2 Guests, 7:00 PM", "2"));
