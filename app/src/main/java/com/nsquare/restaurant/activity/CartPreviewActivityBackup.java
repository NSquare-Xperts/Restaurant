...
public class CartPreviewActivityBackup extends ParentActivity implements CartItemsListAdapter.UpdateValuesInterface {
    ...
    public static CartPreviewActivityBackup cartPreviewActivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cartItemsListAdapter = new MyCartItemsListAdapter(CartPreviewActivityBackup.this,cartModelArrayList);
...
//        super.onBackPressed();
    ...
    public static CartPreviewActivityBackup getInstance(){
