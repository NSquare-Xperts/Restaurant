...
public class TableOrdersActivity extends ParentActivity implements CartItemsListAdapter.UpdateValuesInterface {
    ...
    public static TableOrdersActivity cartPreviewActivity;
    ...
    public String mobileNumber, userName, customer_id = "", customerOrderId = "", tableId = "";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tableId = intent.getStringExtra(getResources().getString(R.string.tableId));
...
//        super.onBackPressed();
    ...
    public static TableOrdersActivity getInstance(){
...
//        }
    ...
    private void getCartItems() {
        ...
        postParams.put(getResources().getString(R.string.tableId), tableId);
        postParams.put(getResources().getString(R.string.customer_id), "");
        postParams.put(getResources().getString(R.string.customerOrderId), "");
...
//            jsonObjectCart.put(getResources().getString(R.string.tableId), getResources().getString(R.string.tableIdValues));
            jsonObjectCart.put(getResources().getString(R.string.tableId), tableId);
