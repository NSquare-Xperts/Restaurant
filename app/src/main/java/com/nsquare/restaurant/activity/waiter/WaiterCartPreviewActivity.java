...
/*        try {
    ...
    private void getCartList() {
        ...
        APIManager.requestPostMethod(WaiterCartPreviewActivity.this, getResources().getString(R.string.getCartList), postParams, new APIManager.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.getInt("status") == 200) {
                        ...
                        if (cartModelArrayList.size() > 0) {
                            ...
                            if(flagisTrue){
                                ...
                                cartItemsListAdapter = new MyCartItemsListAdapter(WaiterCartPreviewActivity.this, cartModelArrayList);
    ...
    private void sendUserOtp() {
        ...
        APIManager.requestPostMethod(WaiterCartPreviewActivity.this, getResources().getString(R.string.sendUserOTP), postParams, new APIManager.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                try {
                    JSONObject jsonObject = new JSONObject(result);
