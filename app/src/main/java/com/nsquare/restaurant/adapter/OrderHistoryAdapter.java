...
public class OrderHistoryAdapter extends RecyclerView.Adapter<OrderHistoryAdapter.MyViewHolder> {
    ...
    private ArrayList<MyOrderHistory> upcomingYourBookingModelArrayList;
    ...
    public OrderHistoryAdapter(Context context, ArrayList<MyOrderHistory> upcomingYourBookingModelArrayList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final MyOrderHistory issueItem = upcomingYourBookingModelArrayList.get(position);
        ...
        //show labell of status
        if(issueItem.getArrayList_order_menu_details().get(position).is_processed.equalsIgnoreCase("0")) {
            holder.list_item_status.setText("Pending");
            holder.list_item_status_bottom.setText("Pending");
        }else if(issueItem.getArrayList_order_menu_details().get(position).is_processed.equalsIgnoreCase("1")){
            holder.list_item_status.setText("Cooking");
            holder.list_item_status_bottom.setText("Cooking");
        }else if(issueItem.getArrayList_order_menu_details().get(position).is_processed.equalsIgnoreCase("2")){
            holder.list_item_status.setText("Cancelled");
            holder.list_item_status_bottom.setText("Cancelled");
        }else if(issueItem.getArrayList_order_menu_details().get(position).is_processed.equalsIgnoreCase("3")){
            holder.list_item_status.setText("Delivered");
            holder.list_item_status_bottom.setText("Delivered");
        }
        // status "is_processed": 0=Pending, 1=Cooking, 2=Cancelled, 3=Delivered
        if(issueItem.getArrayList_order_menu_details().get(position).getIs_processed().equalsIgnoreCase("0")){
        ...
        holder.list_item_veg_menu_list_textview_menu_name.setText(issueItem.getArrayList_order_menu_details().get(position).getDish_name());
        holder.list_item_veg_menu_list_textview_menu_price.setText(context.getResources().getString(R.string.Rs) + " " + issueItem.getArrayList_order_menu_details().get(position).getDish_price());
        holder.list_item_veg_menu_list_textview_quantity.setText(issueItem.getArrayList_order_menu_details().get(position).getDish_quantity());
        holder.list_item_veg_menu_list_textview_total.setText(issueItem.getArrayList_order_menu_details().get(position).getDish_total_amount());
        //holder.list_item_veg_menu_list_textview_menu_description.setText(issueItem.getMe());

        final int[] quantityCount = { Integer.parseInt(issueItem.getArrayList_order_menu_details().get(position).dish_quantity)};
        totalQuantityCount = Integer.parseInt(issueItem.getArrayList_order_menu_details().get(position).getDish_quantity());
        ...
        holder.list_item_selected_cart_menus_imageview_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertRemoveItem(issueItem.getArrayList_order_menu_details().get(position).dish_id);
...
/*
    ...
    public void updateList(ArrayList<MyOrderHistory> data ) {
...
/*public class OrderHistoryAdapter extends RecyclerView.Adapter<OrderHistoryAdapter.MyViewHolder> {
    ...
    private ArrayList<MyOrderHistory> orderHistoryModelArrayList;
    ...
    public OrderHistoryAdapter(Context context, ArrayList<MyOrderHistory> orderHistoryModelArrayList, Activity myActivity) {
        this.orderHistoryModelArrayList = orderHistoryModelArrayList;
        this.context = context;
    ...
    {
        final MyOrderHistory issueItem= orderHistoryModelArrayList.get(position);
        holder.list_item_order_history_textview_order_id.setText("Order id - "+issueItem.getId());
        holder.list_item_order_history_textview_amount.setText("Bill - " +issueItem.getBill_amount());
        //holder.list_item_order_history_textview_time.setText(issueItem.getTime());
        // "is_processed": 0=Pending, 1=Cooking, 2=Cancelled, 3=Delivered
        holder.list_item_order_history_textview_status.setVisibility(View.VISIBLE);
        if(issueItem.getArrayList_order_menu_details().get(position).getIs_processed().equalsIgnoreCase("0")){

            holder.list_item_order_history_textview_status.setText("Pending");
        }else if(issueItem.getArrayList_order_menu_details().get(position).getIs_processed().equalsIgnoreCase("1")){
            holder.list_item_order_history_textview_status.setText("Cooking");
        }else if(issueItem.getArrayList_order_menu_details().get(position).getIs_processed().equalsIgnoreCase("2")){
            holder.list_item_order_history_textview_status.setText("Cancelled");
        }else if(issueItem.getArrayList_order_menu_details().get(position).getIs_processed().equalsIgnoreCase("3")){
            holder.list_item_order_history_textview_status.setText("Done");
        }
