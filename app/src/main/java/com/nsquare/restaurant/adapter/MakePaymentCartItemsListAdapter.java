...
public class MakePaymentCartItemsListAdapter extends RecyclerView.Adapter<MakePaymentCartItemsListAdapter.MyViewHolder> {
    ...
    public MakePaymentCartItemsListAdapter(Context context, ArrayList<MyOrderHistory> upcomingYourBookingModelArrayList, Activity myActivity,String order_id) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        //int total = Integer.parseInt(issueItem.getDatabase_menu_price()) * Integer.parseInt(issueItem.);
        holder.list_item_veg_menu_list_textview_total.setText(issueItem.getArrayList_order_menu_details().get(position).dish_total_amount + "");
...
*/
                        ...
                        .setPositiveButton(myActivity.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (internetConnection.isNetworkAvailable(myActivity)) {
                                    //cancelOrder(position, issueItem.getArrayList_order_menu_details().get(position).dish_id);
                                    cancelOrder();
                                } else {
    ...
    private void cancelOrder() {
        ...
        //String order_id = sharedPreferencesRemember.getString(myActivity.getResources().getString(R.string.order_id),"");

        HashMap<String, String> postParams = new HashMap<>();
        postParams.put(myActivity.getResources().getString(R.string.order_id), order_id);

        ((ParentActivity) myActivity).showProcessingDialog();
        APIManager.requestPostMethod(myActivity, myActivity.getString(R.string.cancelOrder_), postParams, new APIManager.VolleyCallback() {
            @Override
